...
then
  ...
  GLB_SC_PROJECTNAME="ConsoleUserWarden"
  GLB_SC_PROJECTINITIALS="CUW"
  GLB_SC_PROJECTVERSION="1.0.7"
  GLB_SC_PROJECTMAJORVERSION="1"
  GLB_SC_PROJECTDEVELOPER="com.github.execriez"
  GLB_SC_PROJECTSIGNATURE="com.github.execriez.consoleuserwarden"
